                ...
                <div class="card-header justify-content-between">
                  ...
                  <div class="col-sm-12 col-md-12 text-center">
                        <form action = "/admin/add_category" method ="POST" class="form-inline">
                            <?php echo csrf_field(); ?>
                        <div class="form-group">
                            <input type="text" class="form-control" value="<?php echo e(old('name')); ?>" name="name" id="exampleInputName2" placeholder="Add new category here!">
                        </div>
...
<?php echo $__env->make('admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\complain_system\resources\views/category.blade.php ENDPATH**/ ?>