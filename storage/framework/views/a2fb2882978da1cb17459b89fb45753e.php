        ...
        <?php if($errors->any()): ?>
            ...
            <form class="form-pill" method="POST" action="/admin/create_staff">
                ...
                <div class="form-group my-2">
                    <button type="submit" class="btn btn-lg btn-primary btn-block rounded-pill my-4">Sign Up</button>
                </div>
...
<?php echo $__env->make('admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\workspace\complain_app\resources\views/create_staff_form.blade.php ENDPATH**/ ?>