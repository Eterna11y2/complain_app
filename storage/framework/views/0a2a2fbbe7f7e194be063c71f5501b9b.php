                ...
                <div class="card-body pt-0 pb-5 col-md-12">
                  <table class="table card-table table-responsive table-responsive-large" style="width:100%">
                    ...
                    <tr>    
                        ...
                        <button class="btn btn-primary editCategory"  data-toggle="modal" data-target="#modal-contact" data-id="<?php echo e($staffmapping->id); ?>">Edit</button>
...
<?php echo $__env->make('admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\workspace\complain_app\resources\views/staff_mapping.blade.php ENDPATH**/ ?>