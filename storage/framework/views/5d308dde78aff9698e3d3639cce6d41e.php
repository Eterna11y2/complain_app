                ...
                <div class="card-header justify-content-between">
                  ...
                  <div class="col-sm-12 col-md-12 text-center">
                        <form action = "/admin/add_state" method ="POST" class="form-inline">
                            <?php echo csrf_field(); ?>
                        <div class="form-group">
                            <input type="text" class="form-control" name = "state-name" id="exampleInputName2" placeholder="Add new state here!">
                        </div>
...
<?php echo $__env->make('admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\workspace\complain_app\resources\views/state.blade.php ENDPATH**/ ?>