            ...
            <?php if($errors->any()): ?>
              ...
              <div class="card card-table-border-none recent-orders" id="recent-orders">
                ...
                <div class="responsive-data-table">
                    ...
                    <?php $__currentLoopData = $staffmappings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staffmapping): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>    

                        <td><?php echo e($loop->iteration); ?></td>
                        <td><?php echo e($staffmapping->user->name); ?>

                            <br>
                            <small>
                            <span class="badge badge-primary"> <?php echo e($staffmapping->category->name); ?> </span>
                            </small>
                        </td>
                        <td>
                        <!-- Add edit and delete buttons with appropriate links -->
                        <!-- <a href="<?php echo e(url('/categories/'.$category->id.'/edit')); ?>">Edit</a> -->
                        <button class="btn btn-primary editCategory"  data-toggle="modal" data-target="#modal-contact" data-id="<?php echo e($staffmapping->id); ?>" data-staffname="<?php echo e($staffmapping->user->name); ?>" data-catid="<?php echo e($staffmapping->category_id); ?>">Edit</button>
                        <a href="/admin/delete_mapping/<?php echo e($staffmapping->id); ?>" class="btn btn-danger" onclick="return confirm('Are you sure?')">Delete</a>                        
...
<?php echo $__env->make('admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\complain_app\resources\views/staff_mapping.blade.php ENDPATH**/ ?>